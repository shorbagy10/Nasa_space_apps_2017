                ...
                array(
                    ...
                    'content' => function() {
                        return '<p>Like the plugin, but need more features? <a href="http://wp-quiz.ari-soft.com/plugins/wordpress-fancy-lightbox.html#pricing" target="_blank">Upgrade to PRO</a> version:
                                ...
                                <h4>Want upgrade to PRO for <strong>free</strong>? Just <a href="mailto:info@ari-soft.com?subject=' . rawurlencode( 'REQUEST: Free upgrade to "ARI Fancy Lightbox PRO"' ) . '">contact us</a> and know how to do it.</h4>
                            </p>';
                    }
                )
            )
