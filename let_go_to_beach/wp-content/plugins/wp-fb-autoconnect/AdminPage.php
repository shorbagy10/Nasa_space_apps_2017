    ...
    <div class="jfb-admin_wrapper">
		...
		<h3><?php _e("Setup Instructions", 'wp-fb-autoconnect')?></h3>
            ...
            <ol>
			  ...
			  <li><?php _e("When the 'Create a New App ID' window pops up, type in a name (i.e. the name of your site), contact e-mail, select a category, and click 'Create App ID.'", 'wp-fb-autoconnect')?></li>
			  <li><?php _e("Go to the 'Settings' page (link on the left), click 'Add Platform' (at the bottom), 'Website,' then fill in your 'Site URL.'", 'wp-fb-autoconnect')?><br/>
